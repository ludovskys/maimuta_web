...
<input type='button' onclick="envoiSession();" value="Go !" style="vertical-align:-50px; width:80px; margin-left:-200px; margin-right:30px;" />
...
<script type='text/javascript'>
    ...
    $(document).ready(function(){
        recupData2('#leftTasks','liste','all_tache_query');
    });
