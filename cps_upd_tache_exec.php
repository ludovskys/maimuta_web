<?php session_start();
	...
	//echo '<tr><td colspan="2">&raquo; "Code FR: CUCU 2"</td></tr>';
				...
				if($type == "Training Program") // Training Program, pentru ca in baza de date avem id-ul numeric al tipului.
				{
					$j = 8;
					$t = "TP";
				}
				...
				//validation 
				 for ($i = 2; $i <= 5; $i++ ) {
						...
						if (!preg_match('/^\d+$/', $elem[$i])) {
							$success = false;							
							echo "<span style='font-size:18px; color:red;'>Elem[$i] trebuie sa fie pozitiv!<br /></span>";
						}
					}
					if ($elem[2] > $elem[3]) {
						$success = false;
						echo "<span style='font-size:18px; color:red;'>Elem[2] trebuie sa fie mai mic decat elem[3]<br /></span>";
					}	
				...
				else if($type == "CSRT") //"CSRT"
				{
					...
					if ($elem[7] == 2) {
						...
						if (!preg_match('/^\d+$/', $elem[8])) {
								$success = false;							
								echo "<span style='font-size:18px; color:red;'>Elem[8] trebuie sa fie pozitiv!<br /></span>";
						}
					} else {
						$elem[8] = "";
					}
...
?>
				...
				<table id="DMS" style="width:520px;" cellspacing="10px">
					...
					<?php
						...
						$elem6 = get_element("m_fPhase1StimDurIfNoTouchReqdSec");  //OCS:!!!!!!!!!!! In DNMS.php - nu am elem[6]!!!!!!!!!!!!!
					...
					//TODO: Elementul 8 nu este salvat nicaieri, nici in baza de date nici in xml, deci nu-l pot lua de niecaieri.
					?>
...
?>
				<table id="SOSS" style="width:487px;" cellspacing="10px">
					...
					//ATENTIE
					//ATENTIE
					//ATENTIE am modificat si stimuli_figure.php
					//ATENTIE
					//ATENTIE
					//ATENTIE
